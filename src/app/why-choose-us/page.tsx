...
const WhyChooseUs: React.FC = () => {
  return (
    <div className="flex flex-col">
      ...
      <section className="py-32 px-4 sm:px-6 lg:px-8 bg-aramco-gray">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            <span className="aramco-label mx-auto">The Problem</span>
            <h2 className="text-4xl lg:text-6xl font-black text-aramco-navy mb-6 uppercase tracking-tighter">The Standard Software Trap</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-slate-200">
            {[
              ...
              <div key={idx} className="bg-white p-12 hover:bg-red-50 group transition-colors">
                ...
                <h4 className="text-lg font-black text-aramco-navy mb-4 uppercase tracking-widest">{trap.title}</h4>
                <p className="text-slate-500 text-sm leading-relaxed font-medium">{trap.desc}</p>
              </div>
            ))}
          </div>
          <div className="mt-24 text-center">
            <p className="text-3xl font-black text-aramco-navy uppercase tracking-tighter">Standard software may digitize processes. <br />But it rarely creates operational control.</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-4xl lg:text-5xl font-black text-aramco-navy mb-10 uppercase tracking-tighter leading-none">The Logic Unit Advantage</h2>
              ...
              <div className="space-y-8">
                {[
                  ...
                  <div key={idx} className="flex items-center space-x-6">
                    <div className="flex-shrink-0 w-8 h-8 bg-aramco-teal text-white flex items-center justify-center">
      ...
      <section className="py-32 px-4 sm:px-6 lg:px-8 bg-aramco-navy text-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-white/10">
            <div className="bg-aramco-navy p-16 hover:bg-white/5 transition-colors">
              <h3 className="text-2xl font-black mb-8 text-aramco-teal uppercase tracking-widest">Predictability</h3>
            ...
            <div className="bg-aramco-navy p-16 flex items-center justify-center hover:bg-white/5 transition-colors">
              <div className="text-center">
                <div className="text-8xl font-black text-aramco-teal mb-6 tracking-tighter">100%</div>
